...
function LiveEngine(_ref6) {
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, data.leftCaption)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    style: {
      ...
      padding: sm ? 16 : 24,
      aspectRatio: "1 / 1",
      maxWidth: stacked ? 480 : "100%",
      margin: stacked ? "0 auto" : "0"
    }
  ...
  }, data.statusLabel || "Streaming"), /*#__PURE__*/React.createElement("span", {
    className: "t-micro",
    style: {
      color: "var(--ink-3)",
      marginLeft: 8
  ...
  }, data.agentStatus || "Agents · 9/9 nominal")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      ...
      border: "1px solid var(--rule-soft)",
      background: "var(--paper)",
      padding: sm ? "16px 12px" : "20px 18px"
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        flexDirection: "column",
        gap: 6,
        paddingLeft: i > 0 && !sm ? 16 : 0,
        borderLeft: i > 0 && !sm ? "1px solid var(--rule-softer)" : "none"
      }
    }, /*#__PURE__*/React.createElement("span", {
      className: "t-micro",
      style: {
