...
// L0 source labels — explicit vendor names paired across 3 boxes.
// Per marketing feedback: a DSO operator running Eaglesoft sees their
// system named, not an abstract category. Pairing keeps L0 box count = 3
// so the topology geometry doesn't need rebuilding.
var SOURCES = ["Dentrix · Eaglesoft", "Open Dental · Curve", "Carestream · API"];
...
function LivingTopologyHorizontal(_ref5) {
  ...
  }, "Contract \xB7 v0.4.1"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: "var(--ink-3)",
      letterSpacing: "0.04em",
  ...
  }, "patient \xB7 appointment \xB7 claim \xB7 production \xB7 payer")))), /*#__PURE__*/React.createElement(LayerColH, {
    tag: "L3",
    name: "Engine \xB7 9 Agents",
    sub: "9 / 9",
    caption: LAYER_CAPTIONS.L3
