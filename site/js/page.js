...
// ─── Telemetry strip ──────────────────────────────────────────────────
// Thin sticky rail just below the TopBar. Three rotating metric clusters
// cycle every ~3.2s. Reads as "the system itself is running while you
// read the page." Visible across all sections, never dominant.
//
// Cluster format: "primary · secondary" — primary in ink, secondary in
// ink-3. Examples:
//   "9 agents · 4 connectors · engine · live"
//   "uptime 99.98% (90d) · p95 1.2s"
//   "tasks today: 14,812 · queue: 3"

function TelemetryStrip(_ref2) {
  var bp = _ref2.bp;
  var T = window.AFFETTO && window.AFFETTO.telemetry || {};
  var clusters = T.clusters || [];
  var reduced = usePrefersReducedMotion();
  var _useStP3 = useStP(0),
    _useStP4 = _slicedToArray(_useStP3, 2),
    idx = _useStP4[0],
    setIdx = _useStP4[1];
  useEfP(function () {
    if (reduced || clusters.length <= 1) return;
    var id = setInterval(function () {
      setIdx(function (i) {
        return (i + 1) % clusters.length;
      });
    }, 3200);
    return function () {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, T.schemaVersion || "v0.4.1"), !sm && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      width: 1,
      height: 10,
    ...
    style: {
      color: "var(--ink)",
      whiteSpace: "nowrap",
      animation: reduced ? "none" : "telemetryFade 3.2s ease",
      overflow: "hidden",
      textOverflow: "ellipsis",
      minWidth: 0,
      flex: "0 1 auto"
    }
  }, cluster.primary), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      color: "var(--ink-3)",
      whiteSpace: "nowrap"
  ...
  }, cluster.secondary)), sm && /*#__PURE__*/React.createElement("span", {
    key: idx,
    style: {
      color: "var(--ink)",
      whiteSpace: "nowrap",
...
function Access(_ref7) {
  ...
  var _useStP7 = useStP(""),
    ...
    audience = _useStP8[0],
    setAudience = _useStP8[1];
  var _useStP9 = useStP(false),
    _useStP0 = _slicedToArray(_useStP9, 2),
    submitted = _useStP0[0],
    setSubmitted = _useStP0[1];
  return /*#__PURE__*/React.createElement("section", {
    id: "access",
    style: {
      borderBottom: "1px solid var(--rule-soft)"
...
function Page() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(TopBar, {
    bp: bp
  }), /*#__PURE__*/React.createElement(TelemetryStrip, {
    bp: bp
  }), /*#__PURE__*/React.createElement(Masthead, {
    bp: bp
  }), /*#__PURE__*/React.createElement(Hero, {
    bp: bp
  }), /*#__PURE__*/React.createElement(PinnedSystem, {
    bp: bp
  }), /*#__PURE__*/React.createElement(LiveEngine, {
    bp: bp
